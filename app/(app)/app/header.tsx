...
export default function Header() {
	...
	return (
		<header className='bg-card/80 fixed left-0 right-0 top-0 flex h-16 items-center justify-between border-b px-4 backdrop-blur-sm md:m-4 md:grid md:grid-cols-3 md:rounded-xl md:border'>

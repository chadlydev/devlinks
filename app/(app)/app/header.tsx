...
export default function Header() {
	...
	return (
		<header className='bg-card/80 fixed left-0 right-0 top-0 z-10 flex h-16 items-center justify-between border-b px-4 backdrop-blur-sm md:m-6 md:grid md:grid-cols-3 md:rounded-xl md:border'>
